...
${LangFileString} DIFFERENT_USER "Inkscape はユーザ $0 によってインストールされています。$\r$\nこのまま続けると正常に完了しないかもしれません。$\r$\n$0 でログインしてから再度試みてください。"
...
${LangFileString} Alluser "すべてのユーザ"
${LangFileString} AlluserDesc "このコンピュータを使うすべての人にこのアプリケーションをインストール (すべてのユーザ)"
...
${LangFileString} SVGWriterDesc "SVG ファイルの標準エディタに Inkscape を設定"
...
${LangFileString} AlwaysYes "全てはい"
${LangFileString} No "いいえ"
${LangFileString} AlwaysNo "全ていいえ"
