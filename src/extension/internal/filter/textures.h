		...
		Inkscape::Extension::build_from_mem(
            ...
            "<name>" N_("Ink Blot") "</name>\n"
              ...
              "<param name=\"stroke\" gui-text=\"" N_("Stroke:") "\" type=\"enum\">\n"
                "<_item value=\"over\">Wide</_item>\n"
                "<_item value=\"atop\">Normal</_item>\n"
                "<_item value=\"in\">Narrow</_item>\n"
                "<_item value=\"xor\">Overlapping</_item>\n"
                "<_item value=\"out\">External</_item>\n"
                "<_item value=\"arithmetic\">Custom</_item>\n"
              "</param>\n"
