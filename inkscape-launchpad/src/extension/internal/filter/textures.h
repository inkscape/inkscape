...
InkBlot::get_filter_text (Inkscape::Extension::Extension * ext)
{
	...
	_filter = g_strdup_printf(
        "<filter xmlns:inkscape=\"https://www.inkscape.org/namespaces/inkscape\" style=\"color-interpolation-filters:sRGB;\" x=\"-0.15\" width=\"1.3\" y=\"-0.15\" height=\"1.3\" inkscape:label=\"Ink Blot\" >\n"
